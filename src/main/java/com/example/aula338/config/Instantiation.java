...
import com.example.aula338.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Bon voyage!", sdf.parse("2018-03-21"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Prendre plaisir!", sdf.parse("2018-03-22"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Passez une bonne journée!!", sdf.parse("2018-03-23"), new AuthorDTO(alex));
