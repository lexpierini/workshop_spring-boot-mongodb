...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("2018-03-21"), "Vacances!!!", "Je vais voyager à Quebèc.", maria);
		Post post2 = new Post(null, sdf.parse("2018-03-23"), "Bonjour", "Je me suis réveillé heureux aujourd'hui!", maria);
