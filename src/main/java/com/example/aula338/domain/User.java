package com.example.aula338.domain;
...
public class User implements Serializable {
	...
	@DBRef(lazy = true) // lazy = Il garantit que les publications ne seront chargées que si elles sont explicitement accessibles.
